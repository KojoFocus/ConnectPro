  ...
  return (
    <>
      <div className="relative z-10 bg-[#F9FAFB]  text-gray-800 m-0 p-6">
        <div className="w-full bg-gradient-to-r from-[#036082] to-[#023347] rounded-lg shadow-lg text-white px-6 md:px-16 pt-8 pb-5">
          ...
          <p className="text-center text-lg md:text-xl mb-12 max-w-3xl mx-auto">
            Your journey to building a thriving business begins here. Follow
            these simple steps to move from idea to profit with our tailored
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white text-[#036082] rounded-lg shadow-lg p-6 flex flex-col items-center">
              ...
              <p className="text-center text-sm">
                Every business starts with an idea. Let’s develop yours into a
                clear plan.
              </p>
            </div>
            {/* Step 2 */}
            ...
            <div className="bg-white text-[#036082] rounded-lg shadow-lg p-6 flex flex-col items-center">
              ...
              <p className="text-center text-sm">
                We provide the necessary materials, packaging solutions, and
                more.
              </p>
            </div>
            {/* Step 4 */}
            <div className="bg-white text-[#036082] rounded-lg shadow-lg p-6 flex flex-col items-center">
              ...
              <p className="text-center text-sm">
                With our support, your business can scale quickly and
                sustainably.
              </p>
            </div>
          </div>
