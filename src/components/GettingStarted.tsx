...
const GettingStarted = () => {
  return (
    <>
      <Navbar /> {/* Navbar from the Hero Section */}
      <div className="w-full min-h-screen bg-gradient-to-r from-[#036082] to-[#023347] text-white  px-6 md:px-16">
        ...
        <p className="text-center text-lg md:text-xl mb-12 max-w-3xl mx-auto">
          Your journey to building a thriving business begins here. Follow these
          simple steps to move from idea to profit with our tailored solutions
          and expert support.
        </p>
