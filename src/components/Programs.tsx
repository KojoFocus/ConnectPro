...
const Programs = () => {
  ...
  return (
    <div className="collapse bg-[#B0D0D3] mx-0 px-4 rounded-none"> {/* Added rounded-none to remove rounded corners */}
      ...
      {isOpen && (
        <div className="collapse-content p-4 mx-0"> {/* Adjust padding and margin here */}
          {/* Detailed content for Connect Pro program */}
          <h3 className="text-2xl font-semibold mb-4 text-[#023347]">
            Connect Pro
          </h3>
          ...
          <div className="mt-4">
            <h4 className="text-xl font-semibold text-[#023347]">
              Program Benefits:
            </h4>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="card-content p-4">
                <h4 className="text-lg font-semibold text-[#023347] mb-2">
                  Program Overview
                </h4>
