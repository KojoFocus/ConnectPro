...
const ContactUs = () => {
  ...
  return (
    <>
      <div className="collapse bg-[#F3EFE8] p-0">
        <input
          type="checkbox"
  ...
  >
    Send Message
            ...
            <div className="mt-6">
              ...
              <p className="mb-2">Email: <a href="mailto:info@example.com" className="text-sky-500">info@example.com</a></p>
              <p>Phone: <a href="tel:+1234567890" className="text-sky-500">+1 (234) 567-890</a></p>
            </div>
          </div>
        )}
      </div>
